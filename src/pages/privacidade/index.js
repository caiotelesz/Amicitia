...
export default function privacidade() {
  return (
    <section className="section-privacidade">
      ...
      <p>A sua privacidade é importante para nós. É política do Amicitia Vet respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Amicitia Vet, e outros sites que possuímos e operamos.</p>
      ...
      <p>O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de privacidade e informações pessoais. Se você tiver alguma dúvida sobre como lidamos com dados do usuário e informações pessoais, entre em contato connosco.</p>
      
      <h2>Serviço Google AdSense</h2>
      ...
      <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Amicitia Vet oferece no site e com caráter enunciativo, mas não limitativo:</p>
      <ul>
        ...
        <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Amicitia Vet, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
      </ul>
      ...
      <p>Esta política é efetiva a partir de 9 de junho de 2024.</p>
      </div>
